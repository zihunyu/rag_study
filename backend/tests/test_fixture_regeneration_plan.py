    ...
    report = plan(
        {
            "records": [
                ...
                },
                {
                    "fixture_ref": "c",
                    "source_sha256": "z",
                    "representation_status": "DEFERRED_BY_USER",
                },
            ]
        }
    )
    assert (
        report["rebuild_count"] == 1
        and report["blocked_count"] == 1
        and report["records"][0]["fixture_ref"] == "a"
        and report["blocked_records"][0]["fixture_ref"] == "b"
