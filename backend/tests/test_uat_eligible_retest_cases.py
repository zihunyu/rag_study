...
def test_generated_source_fixture_has_locator_aligned_fresh_evidence(tmp_path:Path):
 ...
 doc=ParserRouter().parse('csv',source,new_uuid7());node=doc.nodes[1]
 case={'question':'generated question','evidence':[{'content':node.display_text,'locator':node.locator.to_dict(),'source_classification':'internal'}],'old_model_answer_included':False}
