...
from ragkb.evaluation.fixture_glyph_coverage import glyph_coverage  # noqa: E402
        ...
        records.append(
            {
                ...
                "render_ref": str(rendered),
                "source_sha256": hashlib.sha256(source.read_bytes()).hexdigest(),
                "render_sha256": hashlib.sha256(rendered.read_bytes()).hexdigest(),
                "flagged": coverage["covered"] is False or text != rendered_text,
            }
        )
    return {
...
def main():
    ...
    p.add_argument("pairs_json", type=Path, nargs="?")
    ...
    if a.manifest:
        ...
        raise SystemExit("MANIFEST_OR_PAIRS_REQUIRED")
    if a.output:
