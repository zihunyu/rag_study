...
function resultMessage(turn) {
  ...
  if (result.warnings?.includes('VERIFIER_CONDITION_BUDGET_EXCEEDED')) return '本轮资料中的关键条件较多，尚未完成逐项核对。请选择更少的文档或缩小问题范围后重试。';
